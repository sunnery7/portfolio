    ...
    <section className="c-space my-20">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
            <div className="flex flex-col gap-5 relative sm:p-10 px-5 shadow-2xl shadow-black-200">
                ...
                <div className="backdrop-filter p-3 backdrop-blur-3xl w-fit rounded-3xl" style={currentProject.logoStyle}>
                ...
                <div className="flex items-center justify-between flex-wrap gap-5">
                    ...
                    <a href={currentProject.href} target="_blank" className="flex items-center gap-2 cursor-pointer text-white-600">
                        <p>Check Live Site</p>
